        ...
        <div className="mt-6">
          ...
          <div className="mt-4">
            ...
            <input type="password" name="" id="" placeholder="Enter Password"
             className="w-98 px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500
          ...
          <button type="submit" onClick={handleSubmit} className="rounded-lg mt-4 w-full block bg-blue-500 hover:bg-blue-400 focus:bg-blue-400 text-white font-semibold  px-4 py-3 mt-6">SignUp</button>
        </div>
